...
prompt = 'Выбери случайную страну (Россия, Китай, Грузия, Италия, Япония, Таиланд, Индия, Мексика, Греция, Узбекистан, Франция, Испания, Турция, Корея) и её блюдо. Верни JSON: {"post": "пост до 950 символов: флаг+название, время, порции, калории, ингредиенты с граммами, 6-7 подробных шагов, секрет, история, хештеги", "image_prompt": "english dish description"}'
