...
prompt = 'Выбери случайную страну (Россия, Китай, Грузия, Италия, Япония, Таиланд, Индия, Мексика, Греция, Узбекистан, Франция, Испания, Турция, Корея) и её блюдо. Верни СТРОГО JSON: {"post": "пост СТРОГО ДО 850 символов: флаг+название, время, порции, калории, ингредиенты с граммами, 6-7 шагов, секрет, история, хештеги. Если длиннее 850 - убери секрет и историю", "image_prompt": "english dish description"}'
